...
syn region  pythonString
      ...
      \ contains=pythonEscape,pythonSpaceError,pythonDoctest,@Spell,customBoldComment
...
" Custom highlighting by kevin
syn match customBoldComment ":[^:]*:" contained
hi link customBoldComment Conditional
hi customBoldCOmment cterm=bold
